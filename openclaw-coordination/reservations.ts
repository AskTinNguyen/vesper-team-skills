...
export function getRegistrationPath(state: CoordinationState, dirs: Dirs): string {
 ...
 */
export function getActiveAgents(state: CoordinationState, dirs: Dirs): AgentRegistration[] {
  const now = Date.now();
 ...
 */
export function register(state: CoordinationState, dirs: Dirs): boolean {
 ...
 */
export function updateRegistration(state: CoordinationState, dirs: Dirs): void {
 ...
 */
export function unregister(state: CoordinationState, dirs: Dirs): void {
  if (!state.registered) return;
