...
```bash
node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/init-clone.mjs <站名> --url <原站URL>
```
...
```bash
node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/recon-site.mjs \
  --url <原站URL> \
  --out ~/projects/website-clones/<站名>-clone/RECON \
  --label original

node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/asset-harvest.mjs \
...
node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/network-capture.mjs \
  --url <原站URL> \
  --out ~/projects/website-clones/<站名>-clone/RECON/network \
  --label original

node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/route-crawl.mjs \
  --url <原站URL> \
...
node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/interaction-probe.mjs \
  --url <原站URL> \
  --out ~/projects/website-clones/<站名>-clone/RECON/interactions \
  --label original

node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/sourcemap-hunt.mjs \
  --recon ~/projects/website-clones/<站名>-clone/RECON/original-recon.json \
...
```bash
node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/dna-scaffold.mjs \
  --recon ~/projects/website-clones/<站名>-clone/RECON/original-recon.json \
...
node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/compare-recon.mjs \
...
node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/visual-diff.mjs \
...
node /Users/tinnguyen/.vesper/team-skills/web-clone/scripts/audit-clone.mjs \
