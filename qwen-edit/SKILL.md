---
name: qwen-edit
description: AI-powered image editing using Qwen-Image-Edit-2511 via RunPod serverless. Use for photo editing, reframing, clothing changes, style transfers, and character transformations while preserving identity.
---
