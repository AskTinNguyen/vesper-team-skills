---
name: last7days
description: This skill should be used when reviewing the last 7 days of activity in a git repository, branch, or worktree. It applies when users ask to review recent repo activity, check what happened this week, surface trends, risks, or actionable insights from git history, PRs, and issues. Triggers include "review this week", "what happened in the last 7 days", "weekly review", "last week's activity".
---
...
- User asks for a weekly review of a repo or branch
- User wants to understand what changed recently
- User wants to surface risks, hotspots, or trends
- User asks "what happened this week" or "review last 7 days"
