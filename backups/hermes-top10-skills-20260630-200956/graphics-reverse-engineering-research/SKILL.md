...
description: "Use when investigating how an authorized graphics/rendering effect, shader pipeline, asset format, or visual artifact works. Guides tool-augmented agents through dual-track data/shader research, shared findings ledgers, hypothesis cross-checking, and viewer/prototype verification while enforcing legal and safety boundaries."
version: 1.0.0
author: Hermes Agent
license: MIT
