...
description: "Use when a skill should be applied in repeated bounded passes: define scope, run the skill, verify results, update state, and continue until explicit stop conditions are met."
version: 1.0.0
author: Hermes Agent
license: MIT
