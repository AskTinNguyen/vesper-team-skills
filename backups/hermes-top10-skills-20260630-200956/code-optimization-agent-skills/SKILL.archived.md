...
description: "Use when the user wants the X-post setup for agentic code optimization: read project context, profile real hotspots, apply extreme software optimization, and repeat scientifically verified passes."
version: 1.0.0
author: Hermes Agent
license: MIT
