...
allowed-tools: [Skill(verify-and-ship), Task, TaskCreate, TaskUpdate, TaskList, TaskGet, Bash, Read, Grep, Glob]
---
...
- [ ] Confirm the active task list environment is correct before creating zone tasks.
...
- **Invoke skills directly** — Use `skill: github-sync` and `skill: verify-and-ship` instead of hardcoding script paths
